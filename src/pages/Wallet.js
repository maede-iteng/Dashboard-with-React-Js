            ...
            <Grid container>
                <Grid item lg={6} md={7} sm={12} xs={12}>
                    <Box className={classes.myBalance}>
                        ...
                        <Grid container className={classes.myBalanceData} alignItems='center' justifyContent='space-between'>
                            <Grid item lg={3}>
                            ...
                            <Grid item lg={4}>
                                ...
                                <Typography variant='h5'>$3650 <ArrowUpwardIcon className={classes.arrowUpwardIcon}/></Typography>
                            </Grid>
                            <Grid item lg={3}>
                        ...
                        <Grid container className={classes.myBalanceData} alignItems='center' justifyContent='space-between'>
                            ...
                            <Grid item lg={4}>
                                ...
                                <Typography variant='h5'>2355 <ArrowDownwardIcon className={classes.arrowDownwardIcon}/></Typography>
                            </Grid>
                            <Grid item lg={3}>
