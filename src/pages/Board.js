...
import {StyledTableContainer, StyledTableRow, StyleTableHead, StyleTableCell, boardStyles} from './styles';
                    ...
                    <TableBody>
                        {board.map((row) => (
                            <StyledTableRow key={row.description}>
                                ...
                                <StyleTableCell align="right">{row.RankingIcon} {row.Ranking}</StyleTableCell>
