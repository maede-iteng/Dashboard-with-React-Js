...
export const validationAuthFormSchema = yup.object({
  ...
  password: yup.string('Enter your password').min(8, 'Too Short!').required('password is required'),
...
export const validationPersonalInformationFormSchema = yup.object({
  ...
  PostCode: yup.string('Enter your Post Code').required('Post Code is required'),
...
export const validationUserProfileFormSchema = yup.object({
  fullName: yup
    ...
    .max(50, 'Too Long!')
    .required('Full Name is required'),
  profileImage: yup.string('Enter your Profile Image').required('Profile Image is required'),
});
export const validationFormComponentSchema = yup.object({
  ...
  coursePrice: yup.string('Enter your course price').required('course price is required'),
  courseCategory: yup.string('Enter your course category').required('course category is required'),
  ...
  courseFeatures: yup.string('Enter your course features').required('course features is required'),
  learnerAccessibility: yup
    .string("Enter your learner's Accessibility")
    .required("learner's Accessibility is required"),
  lessonVideo: yup.string('Enter your lesson Video').required('lesson Video is required'),
  videoThumbnail: yup.string('Enter your Video Thumbnail ').required('Video Thumbnail is required'),
  lessonName: yup.string('Enter your lesson Name').required('lesson Name is required'),
