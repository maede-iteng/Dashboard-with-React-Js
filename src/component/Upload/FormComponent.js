            ...
            <Box className={classes.formContainer}>
                <div className={classes.formWrapper}>
                    <form onSubmit={formik.handleSubmit}>
                        <label htmlFor="courseThumbnail" className={classes.label}>Enter Course Thumbnail: </label>
                    ...
                    <label htmlFor="lessonVideo" className={classes.label}>Enter lesson Video: </label>
                    <CustomTextField type="file"
                    ...
                    <label htmlFor="videoThumbnail" className={classes.label}>Enter Video Thumbnail: </label>
                    <CustomTextField type="file"
                                     variant="outlined"
                                     accept="image/*"
                                     fullWidth
