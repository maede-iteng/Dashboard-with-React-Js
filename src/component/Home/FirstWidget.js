                ...
                <Grid item xl={6} lg={6} md={6} sm={12} xs={12}>
                    <Box className={classes.box}>
                        <Grid container justifyContent='space-between' alignItems='center'>
                            ...
                            <Grid item>
                                <Button size='small' variant="contained" className={classes.btnColor}>view all</Button>
                            </Grid>
                        </Grid>
                                ...
                                notificationData.map(notification =>{
                                    return(
                                        <React.Fragment key={notification.id}>
                                            <Grid container spacing={2} justifyContent='space-between' alignItems='center' className={classes.contentWrapper}>
                                                ...
                                                <Grid item className={classes.notifWrapper}>
                                                    <Typography variant='subtitle1' gutterBottom>{notification.message}</Typography>
                                                    <Typography variant='subtitle2' gutterBottom>{notification.date}</Typography>
                                                </Grid>
